---
title: 'Labo 10.1: Collecte de données digitales par screen-scraping'
...
Mais ce n'est pas ce que la page Web ressemble réellement à notre navigateur. Pour afficher le «code source» de la page Web, nous pouvons utiliser le menu déroulant de Chrome appelé «développeur», puis cliquer sur «Afficher la source». 

Aller dans **Views** ==> **Developper** ==> **Developper tools**
...
#section_wiki_f <- html_node(wikipedia_page, xpath = #'/html/body/div[2]/div/div[3]/main/div[3]/div[3]/div[1]/table')
                            ...
                            /html/body/div[2]/div/div[3]/main/div[3]/div[3]/div[1]/table
...
# .headerSort , .jquery-tablesorter td
