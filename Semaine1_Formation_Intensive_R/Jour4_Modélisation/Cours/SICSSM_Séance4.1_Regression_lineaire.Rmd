...
- Rappel du cours sur la causalité
- Exemples graphiques
...
Exemple 1: Ouverture aux média et attitude face à la violence
========================================================
...
Où $\epsilon_i$ suit une loi normale de moyenne 0 et de variance $\sigma^2$. On a k indépendantes variables pour n observations {(Y_i, X_11, X_12, ..., X_1k), ..., (Y_n, X_n1, X_n2, ..., X_nk)}.
